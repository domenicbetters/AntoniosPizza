  ...
  <div class = "main-body bottom-box">
    <div class="vegan-intro-box no-shadow">
      <div class = "vegan-box">
        ...
        <CTAButton  class="vbutton" text="Order now" :link="'https://antoniospizzeria.hungerrush.com/'"/>
      </div>
      <div class = "vegan-box">
        ...
        <CTAButton class="vbutton" @show-menus="showMenus" :clicky="'show-menus'" text="See what specialty pizzas may tempt you"/>
      </div>
      <div class = "vegan-box">
       ...
       <p>We don't just keep ourselves confined to the shop.  We are always out and about in the community, selling our goods where our goods are desired.  It's worth noteing that a lot of times we bring special menus with items exclusive to that event that you won't be able to find in our shop. </p>
        <CTAButton class="vbutton"  @show-main="showMain" :clicky="'show-main'" text="What's coming up?"/>
      </div>
    </div>
</div>
</div>
