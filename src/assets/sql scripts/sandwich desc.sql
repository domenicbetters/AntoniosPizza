...
where groupname = 'hoagies-wraps-wedgies' and SyncStatus = 1 and entid > 200  
...
while @@fetch_status = 0
    begin
		...
		from [dbo].[MenuItmPSMdXRef]
		where groupname = 'hoagies-wraps-wedgies' and SyncStatus = 1 and entid > 200 and  ItemName = @pizzaname
...
select '{ name: '''+pizza+''', desc: '''+toppings+''' },' as taco
from #toppings
order by taco
