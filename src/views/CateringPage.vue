  ...
  <div class = "main-body slide-top bottom-box ">
    <div class="vegan-intro-box no-shadow">
      <form class="row g-3 was-validated">
        ...
        <div class="mb-3">
          <label for="validationServer01" class="form-label">Your Order</label>
          <textarea type="text" class="form-control is-valid" id="validationServer01"  rows="3" required></textarea>
          <div class="invalid-feedback">
